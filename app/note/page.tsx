...
const page = () => {
    ...
    <div className='w-screen h-screen flex flex-col'>
        ...
        <div className='flex flex-col justify-center items-center w-screen flex-grow bg-gray-200 text-black'>
          ...
          <br />
          <textarea className='w-[60%] h-56' name="" id="" defaultValue={text} ref={inputRef}></textarea>
          <button onClick={()=>{updatenote(noteId,inputRef.current!.value).then((res)=>{if(res.message){window.location.replace("/")}})}} className='m-2 mt-4 w-48 h-12 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 '> update </button>
        </div>
