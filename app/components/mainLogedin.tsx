  ...
  return (
    <>
      <div className='flex justify-center bg-gray-400 bg-opacity-90 w-[100%]'>
        <a href="/createNote" target='_blank'>
          <button className='m-2 mt-4 w-48 h-12 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>
            Create Note
          </button>
        </a>
      </div>
      ...
      <div>
        ...
        {notes.map((note, index) => (
          <div className='w-full bg-gray-300 flex h-12 border-black border-t-2' key={note._id}>
